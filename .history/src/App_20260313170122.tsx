...
const VoiceCalendarApp = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black text-white overflow-hidden flex flex-col">
      ...
      <div className="absolute top-0 left-0 right-0 px-4 flex items-center z-50" style={{ height: 'calc(env(safe-area-inset-top) + 60px)', paddingTop: 'env(safe-area-inset-top)' }}>
