              ...
              return (
                <div key={task.id} onClick={() => setExpandedId(expandedId === task.id ? null : task.id)} className="bg-[var(--bg-surface)] rounded-[16px] p-4 flex flex-col shadow-sm cursor-pointer transition-all active:scale-[0.98] active:bg-[var(--bg-surface-elevated)] border border-white/5">
                  <div className="flex items-start gap-3">
                    <button onClick={(e) => { e.stopPropagation(); handleMarkDone(task); }} className="mt-0.5 shrink-0 w-6 h-6 rounded-full border-[1.5px] border-white/30 hover:border-[var(--success)] active:bg-[var(--success)]/20 transition-colors flex items-center justify-center text-transparent hover:text-[var(--success)]">
                ...
                <div key={task.id} className="flex items-center justify-between py-2.5 px-1 border-b border-white/5 last:border-0 group">
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    <button 
                      ...
                      className="shrink-0 text-[var(--success)]/40 hover:text-[var(--success)] transition-colors p-1 -ml-1"
                  ...
                  <button 
                    ...
                    className="shrink-0 text-white/20 hover:text-[var(--danger)] transition-colors p-2 -mr-2"
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
