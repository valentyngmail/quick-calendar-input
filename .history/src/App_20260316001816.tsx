        ...
        <div className="absolute left-6 right-6 flex justify-center z-50 transition-all duration-300" style={{ bottom: 'calc(env(safe-area-inset-bottom) + 20px)' }}>
          <div className="flex items-center gap-3 w-full max-w-sm">
            ...
            <button 
              ...
              className="w-[54px] h-[54px] shrink-0 rounded-full bg-[#1C1C1E]/80 backdrop-blur-2xl border border-white/10 flex items-center justify-center text-[15px] font-bold text-white/80 shadow-xl active:scale-95 transition-transform"
            >
              {appLang.toUpperCase()}
            </button>
