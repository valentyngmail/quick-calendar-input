  ...
  return (
    <div className="fixed inset-0 z-[400] bg-[var(--bg-main)] flex flex-col pt-safe">
      ...
      <div className="px-4 py-3 shrink-0">
        <div className="flex items-center p-0.5 bg-[var(--bg-surface)] rounded-[9px] w-full">
          <button 
          ...
          displayedTasks.map((task) => {
            ...
            return (
              <div 
                ...
                className="bg-[var(--bg-surface)] rounded-2xl p-4 flex flex-col shadow-sm cursor-pointer transition-all active:scale-[0.98] active:bg-[var(--bg-surface-elevated)]"
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button 
                      ...
                      className="px-4 py-1.5 text-[var(--success)] text-[14px] font-bold rounded-[8px] active:opacity-50 transition-opacity ml-1"
