...
interface SettingsModalProps {
  ...
  onSync: (url: string) => void; isSyncing: boolean; syncProgress: string; showDebug: boolean; setShowDebug: (show: boolean) => void;
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-32">
        ...
        <div className="bg-[#1C1C1E] rounded-xl px-4 overflow-hidden">
          ...
          <button onClick={() => onSync(local.fetchLocationsWebhook || '')} className="w-full flex items-center py-3 text-[#34C759] gap-3">
             <div className="w-7 h-7 rounded-md bg-[#34C759] flex items-center justify-center text-white">{isSyncing ? <Loader2 size={16} className="animate-spin" /> : <RefreshCw size={16} />}</div>
...
// ==========================================
// 3. PLACES DATABASE MODAL (РАБОЧАЯ ВЕРСИЯ В НОВОМ ДИЗАЙНЕ)
// ==========================================
